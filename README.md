...
<h3 align="left"> Меня зовут Виктория и я начинающий веб-разработчик.</h3>

- 🔭 Я прошла обучение заканчиваю [дипломный проект](http://movies-project.nomoredomains.work/) в Я.Практикум по специальность "Веб-разработка"
